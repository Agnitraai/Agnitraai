...
This is the move that flips Agnitra AI from "competing with NVIDIA's stack"
...
discipline, and a multi-step engine-build workflow. Agnitra AI wraps that
...
Then point Agnitra AI at the engine:
...
def package_as_nim(
    ...
    *,
    ...
    """Package an Agnitra AI-optimized model as a NIM-compatible container.
    ...
    NIM expects:
        ...
        output_dir/
            ...
            agnitra_optimization.json   # records what Agnitra AI did
...
# the Python backend that calls Agnitra AI. For a NIM-blessed deployment
...
"""Triton Python backend that loads an Agnitra AI-optimized model.
...
underneath via Agnitra AI's backend selector.
"""
import json
import numpy as np
