...
- Follow `docs/operations/publishing.mdx` for the PyPI and npm release checklists, including version bumps, build steps, and publish commands.

## Resources
- `internal-docs/responses_api.mdx` – OpenAI Responses API spec followed by the SDK.
- `docs/operations/docs-deployment.mdx` – Mintlify documentation structure and deployment guide.
