...
- [SDK & CLI Guide](/docs/guides/cli-and-sdk) — command references and return types.
- [Marketplace & Billing](/docs/guides/marketplace) — how telemetry powers pricing workflows.
- [Runtime Configuration](/docs/reference/configuration) — environment variables that toggle telemetry exporters.
