...
description: "How Agnitra interacts with the OpenAI Responses API for optimization hints and telemetry enrichment."
---

# Responses API

Agnitra integrates with the OpenAI Responses API to turn profiler telemetry into actionable optimisation hints. This document summarises the request/response schema, authentication model, and operational guidelines used by the platform.
...
- [SDK & CLI Guide](cli-guide.md) — demonstrates how responses inform local optimisation.
- [Documentation Deployment](docs-deployment.md) — process for updating this reference.
