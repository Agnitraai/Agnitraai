...
Refer to [responses_api.md](responses_api) for the JSON contract and webhook semantics.

## 4. Next Steps

- Review [CLI and SDK guide](cli-guide) for advanced flags, licensing, and offline mode.
- Follow the [Publishing Packages](publishing) checklist to ship PyPI and npm releases.
- Dive into [Monetization Flows](monetization_flows) to understand the usage-to-billing pipeline.
