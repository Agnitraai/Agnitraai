...
- [SDK & CLI Guide](cli-guide) — demonstrates how responses inform local optimisation.
- [Documentation Deployment](docs-deployment) — process for updating this reference.
