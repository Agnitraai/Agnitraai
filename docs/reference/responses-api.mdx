...
- [Runtime Configuration](./configuration) — environment variables that toggle Responses API usage.
- [SDK & CLI Guide](../guides/cli-and-sdk) — how responses inform local optimisation flows.
- [Architecture Overview](../intro/architecture) — where Responses API fits in the optimization loop.
