...
- [Runtime Configuration](/docs/reference/configuration) — environment variables that toggle Responses API usage.
- [SDK & CLI Guide](/docs/guides/cli-and-sdk) — how responses inform local optimisation flows.
- [Architecture Overview](/docs/intro/architecture) — where Responses API fits in the optimization loop.
