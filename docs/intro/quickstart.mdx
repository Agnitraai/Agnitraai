...
Refer to the [Responses API contract](../reference/responses-api) for the JSON schema and webhook semantics.

## 4. Next Steps

- Review the [CLI and SDK guide](../guides/cli-and-sdk) for advanced flags, licensing, and offline mode.
- Plug telemetry into finance tooling via the [Marketplace & Billing guide](../guides/marketplace).
- Browse the [Runtime Configuration reference](../reference/configuration) to tailor Agnitra for your environment.
